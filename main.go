...
import (
	...
	"flag"
	"fmt"
	"github.com/loperd/telegram-bombardier/terminal"
...
func run(ctx context.Context) error {
	...
	go func() {
		...
		userPeer, err := resolver.ResolveDomain(ctx, target)
	...
	flow := auth.NewFlow(terminal.Terminal{PhoneNumber: phone}, auth.SendCodeOptions{})
